        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex gap-3 mt-4">
              <a
                ...
                aria-label="LinkedIn"
                className="w-9 h-9 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center hover:bg-white hover:border-white hover:text-black transition"
              >
              ...
              <a
                ...
                aria-label="Email"
                className="w-9 h-9 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center hover:bg-white hover:border-white hover:text-black transition text-sm"
              >
                ✉
              </a>
            </div>
          ...
          <div>
            ...
            <address className="text-sm not-italic space-y-1 text-gray-400">
              ...
              <p><a href="mailto:hello@deooch.com" className="hover:text-white transition">hello@deooch.com</a></p>
            </address>
          </div>
        </div>
